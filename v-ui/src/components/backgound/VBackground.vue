...
<!--         target="_blank"><img class="icon" src="https://img.springlearn.cn/learn_d98f09cdad8fa38168ec59c15a508490.ico"></a>-->
<!--    </div>-->
  </div>
</template>
...
<script setup lang="ts">
  ...
  const props = defineProps({
    colors: Object as PropType<string[]>,
  });

  const colors = props?.colors || ['#999', '#999', '#999', '#999'];
