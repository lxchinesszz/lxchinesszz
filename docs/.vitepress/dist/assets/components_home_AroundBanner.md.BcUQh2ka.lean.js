import{_ as d,C as p,o as i,b as o,c as h,m as s,a,H as e,w as l,a4 as b}from"./chunks/framework.B8fosacB.js";const m={};function u(t,r){const n=p("v-around-banner");return i(),o(n,{line:""})}const k=d(m,[["render",u]]),y=JSON.parse('{"title":"图片介绍","description":"","frontmatter":{"title":"图片介绍","editLink":true,"sidebar":true,"category":"02-首页模板","aside":false},"headers":[],"relativePath":"components/home/AroundBanner.md","filePath":"components/home/AroundBanner.md","lastUpdated":1726844571000}'),g={name:"components/home/AroundBanner.md"},f=Object.assign(g,{setup(t){return(r,n)=>{const c=p("demo");return i(),h("div",{"data-pagefind-body":!0},[n[1]||(n[1]=s("h1",{id:"首页模板",tabindex:"-1"},[a("首页模板 "),s("a",{class:"header-anchor",href:"#首页模板","aria-label":'Permalink to "首页模板"'},"​")],-1)),n[2]||(n[2]=s("p",null,"用于 PC 端，功能演示等。",-1)),n[3]||(n[3]=s("h2",{id:"完整示例",tabindex:"-1"},[a("完整示例 "),s("a",{class:"header-anchor",href:"#完整示例","aria-label":'Permalink to "完整示例"'},"​")],-1)),e(c,{customClass:"demoblock-custom",sourceCode:`
<template>
