...
<span class="line"><span>  }</span></span></code></pre></div><p>基础结果：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>Hello , 纹银三百两</span></span></code></pre></div><h3 id="_4-2-关系运算符" tabindex="-1">4.2 关系运算符 <a class="header-anchor" href="#_4-2-关系运算符" aria-label="Permalink to &quot;4.2 关系运算符&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>//true</span></span>
...
<span class="line"><span>//false</span></span>
<span class="line"><span>boolean falseValue3=parser.parseExpression(&quot;&#39;5.0067&#39; matches &#39;^-?\\\\d+(\\\\.\\\\d{2})?$&#39;&quot;).getValue(Boolean.class);</span></span></code></pre></div><h3 id="_4-3-逻辑运算符" tabindex="-1">4.3 逻辑运算符 <a class="header-anchor" href="#_4-3-逻辑运算符" aria-label="Permalink to &quot;4.3 逻辑运算符&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// -- AND 与运算 --</span></span>
<span class="line"><span>//false </span></span>
...
<span class="line"><span>//false</span></span>
<span class="line"><span>boolean falseValue5 = parser.parseExpression(&quot;!true&quot;).getValue(Boolean.class);</span></span></code></pre></div><h3 id="_4-4-算术运算符" tabindex="-1">4.4 算术运算符 <a class="header-anchor" href="#_4-4-算术运算符" aria-label="Permalink to &quot;4.4 算术运算符&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// Addition</span></span>
...
<span class="line"><span>int minusTwentyOne = parser.parseExpression(&quot;1+2-3*8&quot;).getValue(Integer.class); // -21</span></span></code></pre></div><h2 id="五、组合使用" tabindex="-1">五、组合使用 <a class="header-anchor" href="#五、组合使用" aria-label="Permalink to &quot;五、组合使用&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span>  }</span></span></code></pre></div><h2 id="六、操作类" tabindex="-1">六、操作类 <a class="header-anchor" href="#六、操作类" aria-label="Permalink to &quot;六、操作类&quot;">​</a></h2><h3 id="_6-1-类类型" tabindex="-1">6.1 类类型 <a class="header-anchor" href="#_6-1-类类型" aria-label="Permalink to &quot;6.1 类类型&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span>  }</span></span></code></pre></div><h3 id="_6-2-自定义函数" tabindex="-1">6.2 自定义函数 <a class="header-anchor" href="#_6-2-自定义函数" aria-label="Permalink to &quot;6.2 自定义函数&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>  }</span></span></code></pre></div><h3 id="_6-3-类属性" tabindex="-1">6.3 类属性 <a class="header-anchor" href="#_6-3-类属性" aria-label="Permalink to &quot;6.3 类属性&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span> @Test</span></span>
...
<span class="line"><span>  }</span></span></code></pre></div><h2 id="八、规则引擎" tabindex="-1">八、规则引擎 <a class="header-anchor" href="#八、规则引擎" aria-label="Permalink to &quot;八、规则引擎&quot;">​</a></h2><h3 id="_8-1-背景" tabindex="-1">8.1 背景 <a class="header-anchor" href="#_8-1-背景" aria-label="Permalink to &quot;8.1 背景&quot;">​</a></h3><p>假设人员注册信息(姓名、年龄、性别），自定义其中规则，如下：</p><p>李家好汉（李姓，男，且满18岁） 豆蔻少女（13-15岁，女性）</p><h3 id="_8-2-实现" tabindex="-1">8.2 实现 <a class="header-anchor" href="#_8-2-实现" aria-label="Permalink to &quot;8.2 实现&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span>  }</span></span></code></pre></div><p><strong>结果：</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>username:【小龙女】,命中规则:【豆蔻少女】</span></span>
<span class="line"><span>username:【李四】,命中规则:【李家好汉】</span></span></code></pre></div><h2 id="九、总结" tabindex="-1">九、总结 <a class="header-anchor" href="#九、总结" aria-label="Permalink to &quot;九、总结&quot;">​</a></h2><p>Spring EL表达式，作为JAVA的内置语言，十分强大。主要可以用来做表达式解析，或者规则链路，且可以操作函数方法；从而达到一种动态的链路规则解析效果。</p>`,57);function u(d,h,g,x,q,b){const a=e("Djt");return i(),p("div",null,[o,l(a),c])}const E=n(r,[["render",u]]);export{v as __pageData,E as default};
