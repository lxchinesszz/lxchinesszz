import{_ as n,c as s,o as a,ac as e}from"./chunks/framework.C9DUt1S1.js";const b=JSON.parse('{"title":"Web接口资源是如何保存起来的?","description":"","frontmatter":{"breadcrumb":false,"navbar":true,"sidebar":true,"pageInfo":true,"contributor":true,"editLink":true,"updateTime":true,"prev":true,"next":true,"comment":true,"footer":true,"backtotop":true,"title":"Web接口资源是如何保存起来的?","category":"SpringBoot"},"headers":[],"relativePath":"java/spring/Web接口资源是如何保存起来的.md","filePath":"java/spring/Web接口资源是如何保存起来的.md"}'),p={name:"java/spring/Web接口资源是如何保存起来的.md"},t=e(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在我们使用 <code>SpringBoot</code> 开发中,我们定义一接口是下面这样的</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@RestController</span></span>
...
<span class="line"><span>public @interface DeleteMapping {}</span></span></code></pre></div><ul><li>我们猜测Spring源码中一定会对<code>@RestController</code> 和 <code>@Controller</code>标记的类,里面的每个 Method进行处理,判断是否包含了上面的注解。注解那么多Spring肯定不会这样一个一个去处理。我们可以看到 上面的注解都使用了<code>@AliasFor</code>注解。其中奥妙就在这里。看下面例子代码。</li><li>我们猜测Spring肯定对这些Method判断是否有<code>@RequestMapping</code>有注解。</li></ul><h3 id="_1-aliasfor使用" tabindex="-1">1. @AliasFor使用 <a class="header-anchor" href="#_1-aliasfor使用" aria-label="Permalink to &quot;1. @AliasFor使用&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@RestController</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>可以看到只要使用下面代码就能把被<code>@PostMapping</code>等等的注解都涵盖了。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>System.out.println(&quot;是否包含RequestMapping: &quot;+AnnotatedElementUtils.hasAnnotation(queryBbsPostAll,RequestMapping.class));</span></span>
<span class="line"><span>RequestMapping mergedAnnotation = AnnotatedElementUtils.getMergedAnnotation(queryBbsPostAll, RequestMapping.class);</span></span></code></pre></div><h3 id="_2-解析请求method" tabindex="-1">2. 解析请求Method <a class="header-anchor" href="#_2-解析请求method" aria-label="Permalink to &quot;2. 解析请求Method&quot;">​</a></h3><p><code>AbstractHandlerMethodMapping</code> 实现 <code>InitializingBean</code>。在当前 <code>Bean</code>初始化时候会执行</p><p><code>afterPropertiesSet -&gt; initHandlerMethods</code></p><p>从这里开始解析Web资源类的信息。请小伙伴们看下面的截图,截图中源码已经把类名也截上了,方便小伙伴们自己在根据截图看一遍源码。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>public abstract class AbstractHandlerMethodMapping&lt;T&gt; extends AbstractHandlerMapping implements InitializingBean {</span></span>
<span class="line"><span></span></span>
