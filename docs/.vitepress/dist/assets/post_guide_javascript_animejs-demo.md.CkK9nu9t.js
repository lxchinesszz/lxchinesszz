import{_ as n,c as a,aa as p,o as i}from"./chunks/framework.FHBy0zsw.js";const u=JSON.parse('{"title":"Animejs示例","description":"","frontmatter":{"title":"Animejs示例","editLink":true,"navbar":true,"category":"JavaScript"},"headers":[],"relativePath":"post/guide/javascript/animejs-demo.md","filePath":"post/guide/javascript/animejs-demo.md"}'),l={name:"post/guide/javascript/animejs-demo.md"};function e(r,s,t,c,b,h){return i(),a("div",null,s[0]||(s[0]=[p(`<h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
