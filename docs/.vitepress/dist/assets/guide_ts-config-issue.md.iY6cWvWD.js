import{_ as s,c as n,o as a,ac as p}from"./chunks/framework.C9DUt1S1.js";const h=JSON.parse('{"title":"typescript配置说明","description":"","frontmatter":{"title":"typescript配置说明","editLink":true,"navbar":true},"headers":[],"relativePath":"guide/ts-config-issue.md","filePath":"guide/ts-config-issue.md"}'),e={name:"guide/ts-config-issue.md"},t=p(`<h1 id="typescript配置说明" tabindex="-1">typescript配置说明 <a class="header-anchor" href="#typescript配置说明" aria-label="Permalink to &quot;typescript配置说明&quot;">​</a></h1><h2 id="无法找到-dirname" tabindex="-1">无法找到__dirname <a class="header-anchor" href="#无法找到-dirname" aria-label="Permalink to &quot;无法找到\\_\\_dirname&quot;">​</a></h2><p>__dirname 是commonjs规范的内置变量。如果使用了esm 是不会自动注入这个变量的。 解决办法。</p><ul><li>&quot;module&quot;: &quot;CommonJS&quot;</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>{</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>或者</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 方法一</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>或者</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 方法二</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>解决了这个问题 ts编译不会报错，但是页面加载还是会报错。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import {defineConfig} from &#39;vite&#39;</span></span>
...
<span class="line"><span>  ]</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,13),l=[t];function i(o,u,c,r,q,d){return a(),n("div",null,l)}const _=s(e,[["render",i]]);export{h as __pageData,_ as default};
