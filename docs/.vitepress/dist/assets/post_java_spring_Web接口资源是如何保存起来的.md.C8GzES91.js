import{_ as s,o as a,c as e,a4 as p}from"./chunks/framework.B8fosacB.js";const d=JSON.parse('{"title":"Web接口资源是如何保存起来的?","description":"","frontmatter":{"breadcrumb":false,"navbar":true,"sidebar":true,"pageInfo":true,"contributor":true,"editLink":true,"updateTime":true,"prev":true,"next":true,"comment":true,"footer":true,"backtotop":true,"title":"Web接口资源是如何保存起来的?","category":"SpringBoot"},"headers":[],"relativePath":"post/java/spring/Web接口资源是如何保存起来的.md","filePath":"post/java/spring/Web接口资源是如何保存起来的.md","lastUpdated":1726844571000}'),l={name:"post/java/spring/Web接口资源是如何保存起来的.md"};function i(t,n,r,c,o,b){return a(),e("div",{"data-pagefind-body":!0},n[0]||(n[0]=[p(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在我们使用 <code>SpringBoot</code> 开发中,我们定义一接口是下面这样的</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>@RestController</span></span>
